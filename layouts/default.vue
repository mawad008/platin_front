<template>
    <div>
       ...
       <div class="d-flex align-items-center gap-5">  
        ...
        <div class="search d-flex align-items-center justify-content-between  px-1" style="">
        <div class="inp">
      ...
      <template v-slot:activator="{ props }">
        ...
        <button v-bind="props">{{ $t('sections') }}</button>
      </template>
      <v-list>
        <!-- <v-list-item
        ...
        <div class="icons-with-profile d-flex gap-3">
         <div class="icons d-flex align-items-center gap-3">
          <div class="icon d-flex align-items-center gap-1">
            <span>en</span>
           ...
           <div class="row ">
            <div class="col-12 col-xl-4 col-lg-4 col-md-6">
              <div class="box-container d-flex flex-column gap-3">
               ...
               <p class=""> 
                منصتنا الإلكترونية هي المكان الذي يجمع بين تجار الذهب والمجوهرات في المملكة.
                 نفتخر بتقديم تجربة شراء آمنة وسلسة، مع تشكيلة واسعة وأنيقة تلبي احتياجاتك.
                </p>
              </div>
            </div>
            ...
            <div class="col-12 col-xl-2 col-lg-3 col-md-6">
              <div class="box-container d-flex flex-column gap-3">
              <h6 class="head" style="font-size: 15px;"> اشترك معنا في القائمة البريدية </h6>
                <div class="links d-flex flex-column gap-4">
                 <span class="head-link">  الرئيسية </span>
                 <div class="input d-flex align-items-center justify-content-center  gap-2">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="19" height="20" viewBox="0 0 19 20" fill="none">
                    <path d="M8.99407 9.73921L12.5546 13.5194C12.5956 13.5628 12.6243 13.6163 12.638 13.6744C12.6517 13.7325 12.6499
                    13.7932 12.6327 13.8504L11.1751 18.6856C11.0459 19.1341 10.4327 19.189 10.2266 18.7701L4.18658
                      ...
                      9.58951 8.95589 9.621 8.95745 9.65297C8.959 9.68493 8.97178 9.71532 8.99353 9.7388L8.99407 9.73921Z" fill="#2D3A4A"/>
                  </svg>
