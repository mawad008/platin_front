              ...
              <div class="text-container">
                <div class="head w-100 d-flex align-items-centr justify-content-between">
                  ...
                  <div class="icons mobile d-flex align-items-center gap-2">
                    ...
                    <div v-if="clickedItem(mainProduct.id) != mainProduct.id" @click="addTofav(mainProduct)"
                    ...
                    <div v-if="clickedItem(mainProduct.id) == mainProduct.id" @click="deleteTofav(mainProduct.id)"
                ...
                <div class="actions-btns">
                  ...
                  <div
                    ...
                    <div v-if="mainProduct.fast_shipping_cities" class="d-flex align-items-center gap-2">
                      <img src="~/assets/images/package.svg" alt="" />
                      <div v-if="mainProduct.fast_shipping_cities.length > 0" class="d-flex align-items-center gap-1 speed">
                        {{ $t("available") }}
          ...
          <div class="actions">
            ...
            <div class="input-number">
              ...
              <span>{{ quantity }}</span>
               ...
               <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 13" fill="none">
    <path d="M10.2915 5.9585H2.70817C2.56451 5.9585 2.42674 6.01556 2.32515 6.11715C2.22357 6.21873 2.1665 6.3565 2.1665 6.50016C2.1665 6.64382 2.22357 6.7816 2.32515 6.88318C2.42674 6.98476 2.56451 7.04183 2.70817 7.04183H10.2915C10.4352 7.04183 10.5729 6.98476 10.6745 6.88318C10.7761 6.7816 10.8332 6.64382 10.8332 6.50016C10.8332 6.3565 10.7761 6.21873 10.6745 6.11715C10.5729 6.01556 10.4352 5.9585 10.2915 5.9585Z" fill="#919EAB"/>
  </svg>
                </button>
            </div>
        ...
        <div id="trigger" class="container d-flex align-items-center justify-content-center" style="margin-top: 65px">
                    ...
                    <div class="rating-container">
                      <div
                        ...
                        <div class="d-flex flex-column align-items-center gap-2">
                          <v-rating style="direction: ltr" half-increments hover :length="5" :size="29"
                            @update:model-value="updateRateInput" color="#919EAB" active-color="#ECB43C" />
                          <span class="text-danger" v-if="rateInputError.rate">{{ rateInputError.rate[0] }}</span>
                        </div>
                      </div>

                      <div class="send-input w-100 d-flex align-items-center justify-content-between">
                        <input type="text" v-model="commentInput" :placeholder="$t('share comment')" />
                        <button @click="addComment()">
                          <span> {{ $t("share") }} </span>
                          <svg class="arrow-icon" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
                            <path
                      ...
                      <div class="comments-container">
                        <div
                          ...
                          <div v-if="AllItems.is_recommended" class="recommend d-flex align-items-center gap-2">
                            <img src="~/assets/images/medal.svg" alt="" />
                            <div class="textt d-flex flex-column gap-1">
                              <span> {{ $t("rec") }} </span>
                              <span class="ratio">
                                {{ $t("rec1") }} ({{ $t(AllItems.recommendationPercentage) }})
                              </span>
                            </div>
                          </div>
                        </div>
                        ...
                        <template v-slot:default="{ items }">
                          ...
                          <div v-for="(item, index) in itemsArray" :key="index"
                            ...
                            <v-rating style="direction: ltr" half-increments readonly :length="5" :size="29"
                              :model-value="item.rate" color="#919EAB" active-color="#ECB43C" />
                          </div>
                          ...
                          <div class="details d-flex flex-column gap-3">
                            ...
                            <div class="info">
                              ...
                              <v-rating style="direction: ltr" half-increments readonly :length="5" :size="20"
                                :model-value="mainVendor.rate" color="#919EAB" active-color="#ECB43C" />
                            </div>
                            <div class="info">
                              <div class="d-flex align-items-center gap-2">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                  ...
                                  <g clip-path="url(#clip0_1472_21212)">
                                    ...
                                    <path
                                      ...
                                      fill="#919EAB" />
                                    <path d="M19.2656 0.412109V4.68791H23.5411L19.2656 0.412109Z" fill="#919EAB" />
                                  </g>
                                  <defs>
                      ...
                      <div class="col-12 col-xl-4 col-lg-4">
                        <div class="most-selling h-100">
                          ...
                          <div class="boxes d-flex flex-column h-100 bg-dange gap-4">
                            <div v-for="item in mainVendor.bestSellerProducts"
