      ...
      <div class="row">
        ...
        <div class="col-12 col-xl-5 col-lg-5 col-md-12">
          <div class="text-container">
            ...
            <div class="type-list w-100 d-flex align-items-center justify-content-between">
            ...
            <div class="actions-btns">
              ...
              <div class="shipping d-flex align-items-center gap-3">
                <div class="d-flex align-items-center gap-2">
                  <img src="~/assets/images/package.svg" alt="">
                  <div class="d-flex align-items-center gap-1 speed">متوفر <span>الشحن السريع</span> في الرياض</div>
                </div>
                <div class="d-flex align-items-center gap-2">
                  <img src="~/assets/images/package.svg" alt="">
        ...
        <div class="col-12 col-xl-7 col-lg-7 col-md-12">
          <div class="d-flex main-swiper-container" style="">
            ...
            <div class="d-flex flex-column align-items-center justify-content-center  swiper-small-imgs">
              ...
              <v-window-item value="one">
                <div class="table-details">
                  <div class="row-container active">
                    ...
                    <span class="det"> القلادة مزخرفة بأناقة وتفاصيل محفورة يدويًا </span>
                    ...
                    <div class="head w-100 d-flex align-items-center justify-content-between mt-4">
                      ...
                      <div class="recommend d-flex align-items-center gap-2">
                        ...
                        <div class="textt d-flex flex-column gap-1">
                          <span> موصي به </span>
                          <span class="ratio"> يوصي المشتري بهذا المنتج (98%) </span>
                        </div>
                      </div>
                    </div>
                        ...
                        <div v-for="(item, index) in itemsArray" :key="index"
                            ...
                            <div class="main d-flex gap-2">
                              ...
                              <div class="text d-flex flex-column gap-1 ">
                                ...
                                <div class="comment-text"> {{ item.showFullText ? item.fullText : item.truncatedText }}
                                  <button v-if="item.fullText.length > maxCharacters" @click="toggleReadMore(index)"> {{
                                    item.showFullText ? 'عرض القليل' : 'عرض المزيد' }} </button></div>
                                <span class="time"> منذ 4 ساعات </span>
                              </div>
                            </div>
                            <v-rating style="direction:ltr;" half-increments readonly :length="5" :size="29" :model-value="3"
                              color="#919EAB" active-color="#ECB43C" />
                          </div>
                ...
                <div class="vendor-details row">
                 ...
                 <div class="col-4">
                  <div class="more-details">
                    <div class="details d-flex flex-column gap-3">
                     ...
                     <div class="info">
                       <div class="d-flex align-items-center gap-2">
                        ...
                        <v-rating style="direction:ltr;" half-increments readonly :length="5" :size="15" :model-value="5"
                                color="#919EAB" active-color="#ECB43C" />
                     </div>
                     <div class="info">
                       <div class="d-flex align-items-center gap-2">
                    ...
                    <p>  زهرة الياقوت هو عالم من الجمال والرقي في عالم المجوهرات. نقدم لكم تشكيلة متنوعة من المجوهرات الفاخرة، مصنوعة بعناية فائقة من أرقى المواد.  </p>
