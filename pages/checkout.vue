<template>
  <div>
    <div class="container checkout-page" style="min-height: 100vh">
      <v-stepper class="w-100" v-model="store.state.step" editable :items="items" show-actions v-if="finalStep == 1">
      ...
      20.4H15.6C16.2628 20.4 16.8 19.8628 16.8 19.2V16.8C16.8 15.5252 16.1375 14.4053 15.138 13.7657Z" fill="" />
                    ...
                    <div v-else>
                      <div class="d-flex  flex-column flex-xl-row flex-lg-row align-items-center gap-3">
                        <div class="main-input">
                          ...
                          <span class="error-msg" v-if="v$.first_name.$error">{{ v$.first_name.$errors[0].$message
                          }}</span>
            ...
            <div class="col-12 col-xl-4 col-lg-4">
              <checkProduct :arrData="arrData" :myFunction="checkoutFunc" :pending="pending" />
            </div>
          </div>
        </template>
                      ...
                      <div class="inputs">
                        <div class="d-flex align-items-center flex-column flex-xl-row flex-lg-row gap-3">
                          <div class="main-input">
                            ...
                            <span class="error-msg" v-if="v2$.city.$error">{{ v2$.city.$errors[0].$message
                            }}</span>
                        ...
                        <div class="d-flex align-items-center flex-column flex-xl-row flex-lg-row  gap-3">
                          <div class="main-input">
                            ...
                            <span class="error-msg" v-if="errors1.district">{{ errors1.district[0] }}</span>
                          </div>
                      ...
                      <div class="details d-flex flex-column gap-3 mt-3">
                        <div class="d-flex align-items-center gap-2">
                          ...
                          <span class="text-word">
                            المملكة العربية السعودية . الرياض . شارع الوحدة 321
                          </span>
                        </div>
                        <div
...
const checkoutFunc1 = async () => {
  ...
  let formBody = new FormData();
  formBody.append("first_name", userdata2.value.city);
  formBody.append("first_name", userdata2.value.first_name);
  formBody.append("first_name", userdata2.value.street_name);
  formBody.append("first_name", userdata2.value.building_number);
  // formBody.append("first_name", userdata2.value.first_name);
  if (check) {
    pending.value = true;
    try {
